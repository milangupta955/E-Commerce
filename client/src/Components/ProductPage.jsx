                        ...
                        <div class="container px-5 py-6 mx-auto">
                            <div class="lg:w-4/5 mx-5 flex flex-wrap">
                                ...
                                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                    ...
                                    <div class="flex mb-4">
                                        <span className='p-0.5 bg-slate-300'>{product.rating}</span>
                                    ...
                                    return (
                                        <div class=" max-w-sm w-full lg:max-w-full lg:flex">
                                            <div class="border-b ml-28 p-2 border-gray-400 lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col">
                                                <div class="mb-8">
                                                    <div class="text-gray-900 font-bold text-xl mb-2">Rating {review.ratingGiven}</div>
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <div class="text-sm">
                                                        <p class="text-gray-900 leading-none">{review.userId.name}</p>
                                                        <p class="text-gray-600">{(String)(new Date(review.dateOfReview))}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
